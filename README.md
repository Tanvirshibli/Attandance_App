...
- Face capture: one centered rounded frame; live fill and still size share a 16% floor so registration advances after a saved capture; missing/corrupt templates prompt re-register
