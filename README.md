...
- Face capture: one centered rounded frame on the full preview; capture waits until the face fills that frame; missing/corrupt templates prompt re-register
